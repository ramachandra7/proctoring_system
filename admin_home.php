...
<body>
    <nav>
        <div class="label">Proctoring System</div>
         <div class="controls">
            <a href="../../common/login/login.php" class="home">
                <div>Logout</div>
            </a>
        </div>
    </nav>
    <div class="container">
        ...
        <div class="admin-options">
            ...
            <a href="../map/map.php" class="mapstudent-wrapper">
                <div class="function">
                    <div class="symbol">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path
            ...
            <a href="../view/view.php" class="viewForms-wrapper">
                <div class="function">
                    <div class="symbol">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                            <path
                    ...
                    <div class="label">Download Forms</div>
                </div>
                <div class="func-info">
                    <p>download the proctoring details submitted by faculty</p>
                </div>
            </a>
